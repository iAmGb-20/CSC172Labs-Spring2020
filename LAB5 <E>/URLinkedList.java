...
public class URLinkedList<E> implements Iterable<E>, URList<E> {
	...
	public void printArray(){
		...
		Object[]storeArray= new Object[toArray().length];
		storeArray=toArray();
	...
	// additional method for iterator
	...
	public static void main(String[] args) {
		...
		System.out.println("here are more tests for the methods");		
